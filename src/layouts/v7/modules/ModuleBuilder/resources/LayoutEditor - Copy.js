...
jQuery.Class('ModuleBuilder_LayoutEditor_Js', {
	...
	makeCMRelatedModuleSortable: function () {
		var thisInstance = this;
		var relatedModulesContainer = jQuery('#relatedTabOrder');
		var modulesList = relatedModulesContainer.find('li.relatedModule');
		relatedModulesContainer.sortable({
	...
	registerCMRelatedListEvent : function(){
        ...
        var thisInstance = this;
		contents 		 = jQuery('.relatedlists2');
		contents.find('.relcheck2').change(function(e) {
	 ...
	 * Function to register all the relatedList Events
	 */
	registerCMRelatedListEvents: function () {
		var thisInstance = this;
		var relatedList = jQuery('#relatedTabOrder');
		var container = relatedList.find('.relatedTabModulesList');
		var allModulesListArray = new Array();
		...
		AppConnector.request(params).then(
			function(data) {
				...
				if(data.success == true) {
					...
					thisInstance.makeCMRelatedModuleSortable();
					thisInstance.registerCMRelatedListEvent();
					thisInstance.registerCMRelatedListEvents();
